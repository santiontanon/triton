...
PLAYER_STATE_DEFAULT:		equ 0    ; assumed to be 0 (otherwise, it'll fail)
...
PLAYER_SECONDARY_BULLET_STRUCT_SIZE:	equ 6  ; the code assumes MAX_PLAYER_SECONDARY_BULLETS == PLAYER_SECONDARY_BULLET_STRUCT_SIZE (options.asm, state-game.asm)
